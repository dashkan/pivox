...
func (s *IamServer) GetAccount(ctx context.Context, req *iampb.GetAccountRequest) (*iampb.Account, error) {
	...
	activeOrg, err := s.resolveActiveOrganization(ctx, identity)
	if err != nil {
		return nil, err
	}
...
func (s *IamServer) resolveActiveOrganization(ctx context.Context, identity *authn.Identity) (*iampb.AccountOrganization, error) {
