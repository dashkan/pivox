...
const file_pivox_iam_v1_groups_proto_rawDesc = "" +
	...
	"createTime\"r\n" +
	"\x0fGetGroupRequest\x12_\n" +
	"\x04name\x18\x01 \x01(\tBK\xe0A\x02\xfaA\x11\n" +
	"\x0fpivox.iam/Group\xbaH1\xba\x01.\n" +
	"\brequired\x12\x11value is required\x1a\x0fthis.size() > 0R\x04name\"\xad\x02\n" +
	"\x11ListGroupsRequest\x12c\n" +
	"\x06parent\x18\x01 \x01(\tBK\xe0A\x02\xfaA\x11\x12\x0fpivox.iam/Group\xbaH1\xba\x01.\n" +
	...
	"\x12CreateGroupRequest\x12c\n" +
	"\x06parent\x18\x01 \x01(\tBK\xe0A\x02\xfaA\x11\x12\x0fpivox.iam/Group\xbaH1\xba\x01.\n" +
	"\brequired\x12\x11value is required\x1a\x0fthis.size() > 0R\x06parent\x124\n" +
	...
	"\x16AddGroupMembersRequest\x12a\n" +
	"\x05group\x18\x01 \x01(\tBK\xe0A\x02\xfaA\x11\n" +
	"\x0fpivox.iam/Group\xbaH1\xba\x01.\n" +
	"\brequired\x12\x11value is required\x1a\x0fthis.size() > 0R\x05group\x12'\n" +
	"\amembers\x18\x02 \x03(\tB\r\xe0A\x02\xbaH\a\x92\x01\x04\b\x01\x10dR\amembers\"\x19\n" +
	"\x17AddGroupMembersResponse\"\xa7\x01\n" +
	"\x19RemoveGroupMembersRequest\x12a\n" +
	"\x05group\x18\x01 \x01(\tBK\xe0A\x02\xfaA\x11\n" +
	"\x0fpivox.iam/Group\xbaH1\xba\x01.\n" +
	"\brequired\x12\x11value is required\x1a\x0fthis.size() > 0R\x05group\x12'\n" +
	"\amembers\x18\x02 \x03(\tB\r\xe0A\x02\xbaH\a\x92\x01\x04\b\x01\x10dR\amembers\"\x1c\n" +
	"\x1aRemoveGroupMembersResponse\"\xcc\x01\n" +
	"\x17ListGroupMembersRequest\x12a\n" +
	"\x05group\x18\x01 \x01(\tBK\xe0A\x02\xfaA\x11\n" +
	"\x0fpivox.iam/Group\xbaH1\xba\x01.\n" +
	"\brequired\x12\x11value is required\x1a\x0fthis.size() > 0R\x05group\x12*\n" +
	"\tpage_size\x18\x02 \x01(\x05B\r\xe0A\x01\xbaH\a\x1a\x05\x18\xe8\a(\x00R\bpageSize\x12\"\n" +
