...
const file_pivox_iam_v1_iam_proto_rawDesc = "" +
	...
	"users.read\x82\xd3\xe4\x93\x02$\x12\"/v1/{parent=organizations/*}/users\x12\xc1\x01\n" +
	"\n" +
	"DeleteUser\x12\x1f.pivox.iam.v1.DeleteUserRequest\x1a\x1d.google.longrunning.Operation\"s\xcaA+\n" +
	"\x15google.protobuf.Empty\x12\x12DeleteUserMetadata\xdaA\x04name\x8a\xb5\x18\x10users.deleteSelf\x82\xd3\xe4\x93\x02$*\"/v1/{name=organizations/*/users/*}\x12|\n" +
