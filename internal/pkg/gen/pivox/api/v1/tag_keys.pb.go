...
type TagKey struct {
	...
	// Output only. The identity that created this tag key.
	...
	// Output only. The identity that last modified this tag key.
...
func (x *TagKey) GetCreatedBy() *types.Actor {
	if x != nil {
		return x.CreatedBy
	}
	return nil
...
func (x *TagKey) GetUpdatedBy() *types.Actor {
	if x != nil {
		return x.UpdatedBy
	}
	return nil
...
const file_pivox_api_v1_tag_keys_proto_rawDesc = "" +
	"\n" +
	"\x1bpivox/api/v1/tag_keys.proto\x12\fpivox.api.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/longrunning/operations.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!pivox/permission/v1/options.proto\x1a\x17pivox/types/actor.proto\"\x84\x05\n" +
	"\x06TagKey\x12\x17\n" +
	...
	"updateTime\x12\x17\n" +
	"\x04etag\x18\n" +
	" \x01(\tB\x03\xe0A\x01R\x04etag\x12L\n" +
	...
	"\x10pivox.api/TagKey\x12.organizations/{organization}/tagKeys/{tag_key}\x12=organizations/{organization}/spaces/{space}/tagKeys/{tag_key}*\atagKeys2\x06tagKey\"\xd9\x01\n" +
	"\x12ListTagKeysRequest\x126\n" +
	"\x06parent\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x12\x12\x10pivox.api/TagKey\xbaH\x03\xc8\x01\x01R\x06parent\x12*\n" +
	...
	"\x10GetTagKeyRequest\x122\n" +
	"\x04name\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x12\n" +
	"\x10pivox.api/TagKey\xbaH\x03\xc8\x01\x01R\x04name\"\xd4\x01\n" +
	"\x13CreateTagKeyRequest\x126\n" +
	"\x06parent\x18\x04 \x01(\tB\x1e\xe0A\x02\xfaA\x12\x12\x10pivox.api/TagKey\xbaH\x03\xc8\x01\x01R\x06parent\x128\n" +
	...
	"\rvalidate_only\x18\x04 \x01(\bB\x03\xe0A\x01R\fvalidateOnly\"\x8c\x01\n" +
	"\x13DeleteTagKeyRequest\x122\n" +
	"\x04name\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x12\n" +
	"\x10pivox.api/TagKey\xbaH\x03\xc8\x01\x01R\x04name\x12(\n" +
	...
	"\x14DeleteTagKeyMetadata2\xc1\t\n" +
	"\aTagKeys\x12\xc7\x01\n" +
	"\vListTagKeys\x12 .pivox.api.v1.ListTagKeysRequest\x1a!.pivox.api.v1.ListTagKeysResponse\"s\xdaA\x06parent\x8a\xb5\x18\ttags.read\x82\xd3\xe4\x93\x02WZ/\x12-/v1/{parent=organizations/*/spaces/*}/tagKeys\x12$/v1/{parent=organizations/*}/tagKeys\x12\xb4\x01\n" +
	"\tGetTagKey\x12\x1e.pivox.api.v1.GetTagKeyRequest\x1a\x14.pivox.api.v1.TagKey\"q\xdaA\x04name\x8a\xb5\x18\ttags.read\x82\xd3\xe4\x93\x02WZ/\x12-/v1/{name=organizations/*/spaces/*/tagKeys/*}\x12$/v1/{name=organizations/*/tagKeys/*}\x12\x8e\x02\n" +
	"\fCreateTagKey\x12!.pivox.api.v1.CreateTagKeyRequest\x1a\x1d.google.longrunning.Operation\"\xbb\x01\xcaA\x1e\n" +
	"\x06TagKey\x12\x14CreateTagKeyMetadata\xdaA\x19parent,tag_key,tag_key_id\x8a\xb5\x18\vtags.create\x82\xd3\xe4\x93\x02i:\atag_keyZ8:\atag_key\"-/v1/{parent=organizations/*/spaces/*}/tagKeys\"$/v1/{parent=organizations/*}/tagKeys\x12\xa8\x02\n" +
	"\fUpdateTagKey\x12!.pivox.api.v1.UpdateTagKeyRequest\x1a\x1d.google.longrunning.Operation\"\xd5\x01\xcaA\x1e\n" +
	"\x06TagKey\x12\x14UpdateTagKeyMetadata\xdaA\x13tag_key,update_mask\x8a\xb5\x18\vtags.update\x9a\xb5\x18\ftag_key.name\x82\xd3\xe4\x93\x02y:\atag_keyZ@:\atag_key25/v1/{tag_key.name=organizations/*/spaces/*/tagKeys/*}2,/v1/{tag_key.name=organizations/*/tagKeys/*}\x12\xe7\x01\n" +
	"\fDeleteTagKey\x12!.pivox.api.v1.DeleteTagKeyRequest\x1a\x1d.google.longrunning.Operation\"\x94\x01\xcaA\x1e\n" +
	"\x06TagKey\x12\x14DeleteTagKeyMetadata\xdaA\x04name\x8a\xb5\x18\vtags.delete\x82\xd3\xe4\x93\x02WZ/*-/v1/{name=organizations/*/spaces/*/tagKeys/*}*$/v1/{name=organizations/*/tagKeys/*}\x1a\x0f\xcaA\fapi.pivox.ioB\xb0\x01\n" +
...
var file_pivox_api_v1_tag_keys_proto_depIdxs = []int32{
	11, // 0: pivox.api.v1.TagKey.created_by:type_name -> pivox.types.Actor
	12, // 1: pivox.api.v1.TagKey.create_time:type_name -> google.protobuf.Timestamp
	11, // 2: pivox.api.v1.TagKey.updated_by:type_name -> pivox.types.Actor
	12, // 3: pivox.api.v1.TagKey.update_time:type_name -> google.protobuf.Timestamp
	10, // 4: pivox.api.v1.TagKey.annotations:type_name -> pivox.api.v1.TagKey.AnnotationsEntry
	0,  // 5: pivox.api.v1.ListTagKeysResponse.tag_keys:type_name -> pivox.api.v1.TagKey
	0,  // 6: pivox.api.v1.CreateTagKeyRequest.tag_key:type_name -> pivox.api.v1.TagKey
	0,  // 7: pivox.api.v1.UpdateTagKeyRequest.tag_key:type_name -> pivox.api.v1.TagKey
	13, // 8: pivox.api.v1.UpdateTagKeyRequest.update_mask:type_name -> google.protobuf.FieldMask
	1,  // 9: pivox.api.v1.TagKeys.ListTagKeys:input_type -> pivox.api.v1.ListTagKeysRequest
	3,  // 10: pivox.api.v1.TagKeys.GetTagKey:input_type -> pivox.api.v1.GetTagKeyRequest
	4,  // 11: pivox.api.v1.TagKeys.CreateTagKey:input_type -> pivox.api.v1.CreateTagKeyRequest
	5,  // 12: pivox.api.v1.TagKeys.UpdateTagKey:input_type -> pivox.api.v1.UpdateTagKeyRequest
	6,  // 13: pivox.api.v1.TagKeys.DeleteTagKey:input_type -> pivox.api.v1.DeleteTagKeyRequest
	2,  // 14: pivox.api.v1.TagKeys.ListTagKeys:output_type -> pivox.api.v1.ListTagKeysResponse
	0,  // 15: pivox.api.v1.TagKeys.GetTagKey:output_type -> pivox.api.v1.TagKey
	14, // 16: pivox.api.v1.TagKeys.CreateTagKey:output_type -> google.longrunning.Operation
	14, // 17: pivox.api.v1.TagKeys.UpdateTagKey:output_type -> google.longrunning.Operation
	14, // 18: pivox.api.v1.TagKeys.DeleteTagKey:output_type -> google.longrunning.Operation
