...
type TagBinding_Origin int32

const (
	// Unspecified origin.
	TagBinding_ORIGIN_UNSPECIFIED TagBinding_Origin = 0
	// Manually applied by a user.
	TagBinding_USER TagBinding_Origin = 1
	// Generated from file metadata extraction (EXIF, XMP).
	TagBinding_SYSTEM TagBinding_Origin = 2
	// Generated by AI auto-tagging.
	TagBinding_AI TagBinding_Origin = 3
)

// Enum value maps for TagBinding_Origin.
var (
	TagBinding_Origin_name = map[int32]string{
		0: "ORIGIN_UNSPECIFIED",
		1: "USER",
		2: "SYSTEM",
		3: "AI",
	}
	TagBinding_Origin_value = map[string]int32{
...
func (x TagBinding_Origin) Enum() *TagBinding_Origin {
	p := new(TagBinding_Origin)
	*p = x
	return p
}

func (x TagBinding_Origin) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TagBinding_Origin) Descriptor() protoreflect.EnumDescriptor {
	return file_pivox_api_v1_tag_bindings_proto_enumTypes[0].Descriptor()
}

func (TagBinding_Origin) Type() protoreflect.EnumType {
	return &file_pivox_api_v1_tag_bindings_proto_enumTypes[0]
}

func (x TagBinding_Origin) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TagBinding_Origin.Descriptor instead.
func (TagBinding_Origin) EnumDescriptor() ([]byte, []int) {
	return file_pivox_api_v1_tag_bindings_proto_rawDescGZIP(), []int{0, 0}
}
...
type TagBinding struct {
	...
	Origin TagBinding_Origin `protobuf:"varint,9,opt,name=origin,proto3,enum=pivox.api.v1.TagBinding_Origin" json:"origin,omitempty"`
...
func (x *TagBinding) GetOrigin() TagBinding_Origin {
	if x != nil {
		return x.Origin
	}
	return TagBinding_ORIGIN_UNSPECIFIED
}
...
const file_pivox_api_v1_tag_bindings_proto_rawDesc = "" +
	...
	"\x06origin\x18\t \x01(\x0e2\x1f.pivox.api.v1.TagBinding.OriginB\x03\xe0A\x03R\x06origin\x12P\n" +
	"\vannotations\x18\n" +
	...
	"\x06Origin\x12\x16\n" +
	"\x12ORIGIN_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04USER\x10\x01\x12\n" +
	"\n" +
	"\x06SYSTEM\x10\x02\x12\x06\n" +
	"\x02AI\x10\x03:\x90\x02\xeaA\x8c\x02\n" +
...
var file_pivox_api_v1_tag_bindings_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_pivox_api_v1_tag_bindings_proto_goTypes = []any{
	(TagBinding_Origin)(0),            // 0: pivox.api.v1.TagBinding.Origin
	(*TagBinding)(nil),                // 1: pivox.api.v1.TagBinding
	(*GetTagBindingRequest)(nil),      // 2: pivox.api.v1.GetTagBindingRequest
	(*CreateTagBindingRequest)(nil),   // 3: pivox.api.v1.CreateTagBindingRequest
	(*DeleteTagBindingRequest)(nil),   // 4: pivox.api.v1.DeleteTagBindingRequest
	(*ListTagBindingsRequest)(nil),    // 5: pivox.api.v1.ListTagBindingsRequest
	(*ListTagBindingsResponse)(nil),   // 6: pivox.api.v1.ListTagBindingsResponse
	(*ListEffectiveTagsRequest)(nil),  // 7: pivox.api.v1.ListEffectiveTagsRequest
	(*ListEffectiveTagsResponse)(nil), // 8: pivox.api.v1.ListEffectiveTagsResponse
	(*EffectiveTag)(nil),              // 9: pivox.api.v1.EffectiveTag
...
func file_pivox_api_v1_tag_bindings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_pivox_api_v1_tag_bindings_proto_enumTypes,
