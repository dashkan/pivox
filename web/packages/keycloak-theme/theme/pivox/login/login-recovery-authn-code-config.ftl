...
<#elseif section = "form">
    ...
    <div class="kc-actions kc-actions-row">
        ...
        <button id="downloadRecoveryCodes" class="kc-btn kc-btn-outline" type="button">
            ${msg("recovery-codes-download")}
        </button>
        <button id="copyRecoveryCodes" class="kc-btn kc-btn-outline" type="button">
    ...
    <div class="kc-row">
        <label class="kc-check-row">
            <input class="kc-checkbox" type="checkbox" id="kcRecoveryCodesConfirmationCheck" name="kcRecoveryCodesConfirmationCheck"
            onchange="document.getElementById('saveRecoveryAuthnCodesBtn').disabled = !this.checked;"
            />
            <span class="kc-check-label">${msg("recovery-codes-confirmation-message")}</span>
        </label>
    </div>

    <form action="${url.loginAction}" class="kc-stack" id="kc-recovery-codes-settings-form" method="post">
