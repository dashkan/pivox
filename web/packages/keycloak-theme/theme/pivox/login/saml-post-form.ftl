...
<@layout.registrationLayout; section>
    ...
    <#elseif section = "form">
        ...
        <p class="kc-prose">${msg("saml.post-form.message")}</p>
        <form name="saml-post-binding" method="post" action="${samlPost.url}">
            ...
            <noscript>
                <p class="kc-prose">${msg("saml.post-form.js-disabled")}</p>
                <div class="kc-actions">
                    <button class="kc-btn kc-btn-primary" type="submit">${msg("doContinue")}</button>
                </div>
            </noscript>
        </form>
    </#if>
