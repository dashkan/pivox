...
public struct Pivox_Api_V1_WatchRequest: Sendable {
...
public struct Pivox_Api_V1_ChangeBatch: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// A list of Change messages.
  public var changes: [Pivox_Api_V1_Change] = []
...
public struct Pivox_Api_V1_Change: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var state: Pivox_Api_V1_Change.State = .exists
  ...
  public enum State: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Pivox_Api_V1_Change.State] = [
      .exists,
      .doesNotExist,
      .initialStateSkipped,
      .error,
...
extension Pivox_Api_V1_WatchRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WatchRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}targets\0\u{3}resume_marker\0")
  ...
  public static func ==(lhs: Pivox_Api_V1_WatchRequest, rhs: Pivox_Api_V1_WatchRequest) -> Bool {
...
extension Pivox_Api_V1_ChangeBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Pivox_Api_V1_ChangeBatch, rhs: Pivox_Api_V1_ChangeBatch) -> Bool {
...
extension Pivox_Api_V1_Change: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Change"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}element\0\u{1}state\0\u{4}\u{2}resume_marker\0\u{1}continued\0\u{1}data\0")
  ...
  public static func ==(lhs: Pivox_Api_V1_Change, rhs: Pivox_Api_V1_Change) -> Bool {
...
extension Pivox_Api_V1_Change.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0EXISTS\0\u{1}DOES_NOT_EXIST\0\u{1}INITIAL_STATE_SKIPPED\0\u{1}ERROR\0")
}
