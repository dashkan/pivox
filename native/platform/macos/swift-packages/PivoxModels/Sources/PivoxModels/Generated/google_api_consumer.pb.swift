...
///        type: INT64
public struct Google_Api_ProjectProperties: Sendable {
...
public struct Google_Api_Property: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum PropertyType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Google_Api_Property.PropertyType] = [
      .unspecified,
      .int64,
      .bool,
      .string,
...
extension Google_Api_Property: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}type\0\u{1}description\0")
...
extension Google_Api_Property.PropertyType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNSPECIFIED\0\u{1}INT64\0\u{1}BOOL\0\u{1}STRING\0\u{1}DOUBLE\0")
}
