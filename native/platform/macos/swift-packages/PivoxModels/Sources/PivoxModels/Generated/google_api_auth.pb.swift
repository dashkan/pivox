...
public struct Google_Api_Authentication: Sendable {
...
/// ignored.
public struct Google_Api_AuthenticationRule: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var oauth: Google_Api_OAuthRequirements {
    get {_oauth ?? Google_Api_OAuthRequirements()}
    set {_oauth = newValue}
  }
  /// Returns true if `oauth` has been explicitly set.
  public var hasOauth: Bool {self._oauth != nil}
...
public struct Google_Api_JwtLocation: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var cookie: String {
    get {
      if case .cookie(let v)? = `in` {return v}
      return String()
    }
    set {`in` = .cookie(newValue)}
  }
  ...
  public enum OneOf_In: Equatable, Sendable {
    /// Specifies HTTP header name to extract JWT token.
    case header(String)
    /// Specifies URL query parameter name to extract JWT token.
    case query(String)
...
public struct Google_Api_AuthProvider: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Api_OAuthRequirements: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// [JSON Web Token
/// (JWT)](https://tools.ietf.org/html/draft-ietf-oauth-json-web-token-32).
public struct Google_Api_AuthRequirement: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Api_Authentication: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{3}rules\0\u{1}providers\0")
...
extension Google_Api_AuthenticationRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selector\0\u{1}oauth\0\u{4}\u{3}allow_without_credential\0\u{2}\u{2}requirements\0")
...
extension Google_Api_JwtLocation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}header\0\u{1}query\0\u{3}value_prefix\0\u{1}cookie\0")
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if case .cookie(let v)? = self.`in` {
...
extension Google_Api_AuthProvider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}issuer\0\u{3}jwks_uri\0\u{1}audiences\0\u{3}authorization_url\0\u{3}jwt_locations\0")
...
extension Google_Api_OAuthRequirements: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}canonical_scopes\0")
...
extension Google_Api_AuthRequirement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}provider_id\0\u{1}audiences\0")
