...
public struct Google_Api_MetricDescriptor: Sendable {
  ...
  public var metadata: Google_Api_MetricDescriptor.MetricDescriptorMetadata {
    get {_metadata ?? Google_Api_MetricDescriptor.MetricDescriptorMetadata()}
  ...
  public var monitoredResourceTypes: [String] = []
  ...
  public enum MetricKind: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Google_Api_MetricDescriptor.MetricKind] = [
      .unspecified,
      .gauge,
      .delta,
      .cumulative,
  ...
  public enum ValueType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Google_Api_MetricDescriptor.ValueType] = [
      .unspecified,
      .bool,
      .int64,
      .double,
  ...
  public struct MetricDescriptorMetadata: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var samplePeriod: SwiftProtobuf.Google_Protobuf_Duration {
      get {_samplePeriod ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_samplePeriod = newValue}
    }
    /// Returns true if `samplePeriod` has been explicitly set.
    public var hasSamplePeriod: Bool {self._samplePeriod != nil}
    /// Clears the value of `samplePeriod`. Subsequent reads from it will return its default value.
    public mutating func clearSamplePeriod() {self._samplePeriod = nil}

    /// The delay of data points caused by ingestion. Data points older than this
    /// age are guaranteed to be ingested and available to be read, excluding
    /// data loss due to errors.
    public var ingestDelay: SwiftProtobuf.Google_Protobuf_Duration {
      get {_ingestDelay ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_ingestDelay = newValue}
    }
    /// Returns true if `ingestDelay` has been explicitly set.
    public var hasIngestDelay: Bool {self._ingestDelay != nil}
    /// Clears the value of `ingestDelay`. Subsequent reads from it will return its default value.
    public mutating func clearIngestDelay() {self._ingestDelay = nil}

    /// The scope of the timeseries data of the metric.
    public var timeSeriesResourceHierarchyLevel: [Google_Api_MetricDescriptor.MetricDescriptorMetadata.TimeSeriesResourceHierarchyLevel] = []

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    /// The resource hierarchy level of the timeseries data of a metric.
    public enum TimeSeriesResourceHierarchyLevel: SwiftProtobuf.Enum, Swift.CaseIterable {
      public typealias RawValue = Int
      ...
      // The compiler won't synthesize support with the UNRECOGNIZED case.
      public static let allCases: [Google_Api_MetricDescriptor.MetricDescriptorMetadata.TimeSeriesResourceHierarchyLevel] = [
        .unspecified,
        .project,
        .organization,
        .folder,
...
public struct Google_Api_Metric: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Api_MetricDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}labels\0\u{3}metric_kind\0\u{3}value_type\0\u{1}unit\0\u{1}description\0\u{3}display_name\0\u{1}type\0\u{2}\u{2}metadata\0\u{4}\u{2}launch_stage\0\u{3}monitored_resource_types\0")
...
extension Google_Api_MetricDescriptor.MetricKind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0METRIC_KIND_UNSPECIFIED\0\u{1}GAUGE\0\u{1}DELTA\0\u{1}CUMULATIVE\0")
}

extension Google_Api_MetricDescriptor.ValueType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0VALUE_TYPE_UNSPECIFIED\0\u{1}BOOL\0\u{1}INT64\0\u{1}DOUBLE\0\u{1}STRING\0\u{1}DISTRIBUTION\0\u{1}MONEY\0")
}
...
extension Google_Api_MetricDescriptor.MetricDescriptorMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Api_MetricDescriptor.protoMessageName + ".MetricDescriptorMetadata"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}launch_stage\0\u{3}sample_period\0\u{3}ingest_delay\0\u{3}time_series_resource_hierarchy_level\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedEnumField(value: &self.timeSeriesResourceHierarchyLevel) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.timeSeriesResourceHierarchyLevel.isEmpty {
      try visitor.visitPackedEnumField(value: self.timeSeriesResourceHierarchyLevel, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Api_MetricDescriptor.MetricDescriptorMetadata, rhs: Google_Api_MetricDescriptor.MetricDescriptorMetadata) -> Bool {
    if lhs.launchStage != rhs.launchStage {return false}
    if lhs._samplePeriod != rhs._samplePeriod {return false}
    if lhs._ingestDelay != rhs._ingestDelay {return false}
    if lhs.timeSeriesResourceHierarchyLevel != rhs.timeSeriesResourceHierarchyLevel {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Api_MetricDescriptor.MetricDescriptorMetadata.TimeSeriesResourceHierarchyLevel: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TIME_SERIES_RESOURCE_HIERARCHY_LEVEL_UNSPECIFIED\0\u{1}PROJECT\0\u{1}ORGANIZATION\0\u{1}FOLDER\0")
}
...
extension Google_Api_Metric: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{2}labels\0\u{1}type\0")
