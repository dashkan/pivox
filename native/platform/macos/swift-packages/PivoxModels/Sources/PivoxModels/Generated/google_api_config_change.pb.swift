...
/// configuration.
public enum Google_Api_ChangeType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Google_Api_ChangeType] = [
    .unspecified,
    .added,
    .removed,
    .modified,
...
public struct Google_Api_ConfigChange: Sendable {
...
public struct Google_Api_Advice: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Api_ChangeType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CHANGE_TYPE_UNSPECIFIED\0\u{1}ADDED\0\u{1}REMOVED\0\u{1}MODIFIED\0")
}
...
extension Google_Api_ConfigChange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}element\0\u{3}old_value\0\u{3}new_value\0\u{3}change_type\0\u{1}advices\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularEnumField(value: &self.changeType) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.advices) }()
      default: break
      }
    }
  }
...
extension Google_Api_Advice: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{2}description\0")
