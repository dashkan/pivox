...
/// here.
public struct Google_Api_Context: Sendable {
...
/// element.
public struct Google_Api_ContextRule: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var allowedRequestExtensions: [String] = []

  /// A list of full type names or extension IDs of extensions allowed in grpc
  /// side channel from backend to client.
  public var allowedResponseExtensions: [String] = []
...
extension Google_Api_ContextRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selector\0\u{1}requested\0\u{1}provided\0\u{3}allowed_request_extensions\0\u{3}allowed_response_extensions\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.requested) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.provided) }()
      case 4: try { try decoder.decodeRepeatedStringField(value: &self.allowedRequestExtensions) }()
      case 5: try { try decoder.decodeRepeatedStringField(value: &self.allowedResponseExtensions) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.allowedRequestExtensions.isEmpty {
      try visitor.visitRepeatedStringField(value: self.allowedRequestExtensions, fieldNumber: 4)
    }
    if !self.allowedResponseExtensions.isEmpty {
      try visitor.visitRepeatedStringField(value: self.allowedResponseExtensions, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Google_Api_ContextRule, rhs: Google_Api_ContextRule) -> Bool {
    ...
    if lhs.allowedRequestExtensions != rhs.allowedRequestExtensions {return false}
    if lhs.allowedResponseExtensions != rhs.allowedResponseExtensions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
