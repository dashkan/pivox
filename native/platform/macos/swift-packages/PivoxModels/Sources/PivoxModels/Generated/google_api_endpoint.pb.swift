...
///       # to proceed.
///       allow_cors: true
public struct Google_Api_Endpoint: Sendable {
...
extension Google_Api_Endpoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}aliases\0\u{4}\u{3}allow_cors\0\u{2}`\u{1}target\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularBoolField(value: &self.allowCors) }()
      case 101: try { try decoder.decodeSingularStringField(value: &self.target) }()
      default: break
      }
    }
  }
