...
public struct Google_Api_Documentation: Sendable {
  ...
  public var serviceRootURL: String = String()
...
public struct Google_Api_DocumentationRule: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Api_Page: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Api_Documentation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}summary\0\u{1}overview\0\u{1}rules\0\u{3}documentation_root_url\0\u{1}pages\0\u{3}service_root_url\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.overview) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.rules) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.documentationRootURL) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.pages) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.serviceRootURL) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.serviceRootURL.isEmpty {
      try visitor.visitSingularStringField(value: self.serviceRootURL, fieldNumber: 6)
    }
  ...
  public static func ==(lhs: Google_Api_Documentation, rhs: Google_Api_Documentation) -> Bool {
    ...
    if lhs.serviceRootURL != rhs.serviceRootURL {return false}
...
extension Google_Api_DocumentationRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selector\0\u{1}description\0\u{3}deprecation_description\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.deprecationDescription) }()
      default: break
      }
    }
  }
...
extension Google_Api_Page: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}content\0\u{1}subpages\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.subpages) }()
      default: break
      }
    }
  }
