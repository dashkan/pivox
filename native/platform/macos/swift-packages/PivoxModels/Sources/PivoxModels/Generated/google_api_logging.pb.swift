...
///         logs:
///         - activity_history
public struct Google_Api_Logging: Sendable {
  ...
  public struct LoggingDestination: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Google_Api_Logging.LoggingDestination: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}logs\0\u{4}\u{2}monitored_resource\0")
