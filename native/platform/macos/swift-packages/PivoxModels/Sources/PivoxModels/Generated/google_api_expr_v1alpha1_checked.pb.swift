...
public struct Google_Api_Expr_V1alpha1_Type: @unchecked Sendable {
  ...
  public struct ListType: @unchecked Sendable {
    ...
    public var elemType: Google_Api_Expr_V1alpha1_Type {
      get {_storage._elemType ?? Google_Api_Expr_V1alpha1_Type()}
      set {_uniqueStorage()._elemType = newValue}
    }
    /// Returns true if `elemType` has been explicitly set.
    public var hasElemType: Bool {_storage._elemType != nil}
  ...
  public struct MapType: @unchecked Sendable {
    ...
    public var keyType: Google_Api_Expr_V1alpha1_Type {
      get {_storage._keyType ?? Google_Api_Expr_V1alpha1_Type()}
    ...
    public var valueType: Google_Api_Expr_V1alpha1_Type {
      get {_storage._valueType ?? Google_Api_Expr_V1alpha1_Type()}
  ...
  public struct FunctionType: @unchecked Sendable {
    ...
    public var resultType: Google_Api_Expr_V1alpha1_Type {
      get {_storage._resultType ?? Google_Api_Expr_V1alpha1_Type()}
      set {_uniqueStorage()._resultType = newValue}
    }
    /// Returns true if `resultType` has been explicitly set.
    public var hasResultType: Bool {_storage._resultType != nil}
...
public struct Google_Api_Expr_V1alpha1_Decl: Sendable {
  ...
  public struct IdentDecl: Sendable {
    ...
    public var type: Google_Api_Expr_V1alpha1_Type {
      get {_type ?? Google_Api_Expr_V1alpha1_Type()}
      set {_type = newValue}
    }
    ...
    public var value: Google_Api_Expr_V1alpha1_Constant {
      get {_value ?? Google_Api_Expr_V1alpha1_Constant()}
      set {_value = newValue}
    }
  ...
  public struct FunctionDecl: Sendable {
    ...
    public struct Overload: Sendable {
      ...
      public var resultType: Google_Api_Expr_V1alpha1_Type {
        get {_resultType ?? Google_Api_Expr_V1alpha1_Type()}
        set {_resultType = newValue}
      }
      /// Returns true if `resultType` has been explicitly set.
      public var hasResultType: Bool {self._resultType != nil}
      /// Clears the value of `resultType`. Subsequent reads from it will return its default value.
