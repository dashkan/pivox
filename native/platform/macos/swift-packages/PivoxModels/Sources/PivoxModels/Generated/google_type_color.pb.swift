...
///
///     // ...
public struct Google_Type_Color: Sendable {
  ...
  public var alpha: SwiftProtobuf.Google_Protobuf_FloatValue {
    get {_alpha ?? SwiftProtobuf.Google_Protobuf_FloatValue()}
    set {_alpha = newValue}
  }
...
extension Google_Type_Color: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._alpha) }()
      default: break
      }
    }
  }
