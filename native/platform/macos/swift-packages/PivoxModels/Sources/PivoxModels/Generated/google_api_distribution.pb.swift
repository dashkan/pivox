...
public struct Google_Api_Distribution: Sendable {
  ...
  public var range: Google_Api_Distribution.Range {
    get {_range ?? Google_Api_Distribution.Range()}
    set {_range = newValue}
  }
  ...
  public var bucketOptions: Google_Api_Distribution.BucketOptions {
    get {_bucketOptions ?? Google_Api_Distribution.BucketOptions()}
    set {_bucketOptions = newValue}
  }
  /// Returns true if `bucketOptions` has been explicitly set.
  public var hasBucketOptions: Bool {self._bucketOptions != nil}
  ...
  public var exemplars: [Google_Api_Distribution.Exemplar] = []
  ...
  public struct BucketOptions: Sendable {
    ...
    /// Exactly one of these three fields must be set.
    public enum OneOf_Options: Equatable, Sendable {
      /// The linear bucket.
    ...
    public struct Explicit: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  public struct Exemplar: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var attachments: [SwiftProtobuf.Google_Protobuf_Any] = []
...
extension Google_Api_Distribution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}count\0\u{1}mean\0\u{3}sum_of_squared_deviation\0\u{1}range\0\u{4}\u{2}bucket_options\0\u{3}bucket_counts\0\u{2}\u{3}exemplars\0")
...
extension Google_Api_Distribution.BucketOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}linear_buckets\0\u{3}exponential_buckets\0\u{3}explicit_buckets\0")
...
extension Google_Api_Distribution.BucketOptions.Linear: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}num_finite_buckets\0\u{1}width\0\u{1}offset\0")
...
extension Google_Api_Distribution.BucketOptions.Exponential: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}num_finite_buckets\0\u{3}growth_factor\0\u{1}scale\0")
...
extension Google_Api_Distribution.BucketOptions.Explicit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}bounds\0")
...
extension Google_Api_Distribution.Exemplar: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Api_Distribution.protoMessageName + ".Exemplar"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}value\0\u{1}timestamp\0\u{1}attachments\0")
  ...
  public static func ==(lhs: Google_Api_Distribution.Exemplar, rhs: Google_Api_Distribution.Exemplar) -> Bool {
