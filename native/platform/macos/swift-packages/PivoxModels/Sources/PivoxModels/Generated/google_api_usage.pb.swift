...
public struct Google_Api_Usage: Sendable {
...
///         allow_unregistered_calls: true
public struct Google_Api_UsageRule: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Api_Usage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}requirements\0\u{2}\u{5}rules\0\u{3}producer_notification_channel\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularStringField(value: &self.producerNotificationChannel) }()
      default: break
      }
    }
  }
...
extension Google_Api_UsageRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selector\0\u{3}allow_unregistered_calls\0\u{3}skip_service_control\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self.allowUnregisteredCalls) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.skipServiceControl) }()
      default: break
      }
    }
  }
