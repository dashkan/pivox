...
public struct Google_Api_LabelDescriptor: Sendable {
  ...
  public enum ValueType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Google_Api_LabelDescriptor.ValueType] = [
      .string,
      .bool,
      .int64,
    ]
...
extension Google_Api_LabelDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}key\0\u{3}value_type\0\u{1}description\0")
...
extension Google_Api_LabelDescriptor.ValueType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0STRING\0\u{1}BOOL\0\u{1}INT64\0")
}
