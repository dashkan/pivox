...
///        metric_kind: DELTA
///        value_type: INT64
public struct Google_Api_Quota: Sendable {
...
public struct Google_Api_MetricRule: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Api_QuotaLimit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Api_Quota: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{3}limits\0\u{3}metric_rules\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.limits) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.metricRules) }()
      default: break
      }
    }
  }
...
extension Google_Api_MetricRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selector\0\u{3}metric_costs\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufInt64>.self, value: &self.metricCosts) }()
      default: break
      }
    }
  }
...
extension Google_Api_QuotaLimit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{2}description\0\u{3}default_limit\0\u{3}max_limit\0\u{1}duration\0\u{1}name\0\u{3}free_tier\0\u{1}metric\0\u{1}unit\0\u{1}values\0\u{4}\u{2}display_name\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.defaultLimit) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.maxLimit) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.duration) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.freeTier) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self.metric) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self.unit) }()
      case 10: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufInt64>.self, value: &self.values) }()
      case 12: try { try decoder.decodeSingularStringField(value: &self.displayName) }()
      default: break
      }
    }
  }
