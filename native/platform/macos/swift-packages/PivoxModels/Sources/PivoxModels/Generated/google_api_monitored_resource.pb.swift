...
/// by the API.
public struct Google_Api_MonitoredResourceDescriptor: Sendable {
...
///                   "zone": "us-central1-a" }}
public struct Google_Api_MonitoredResource: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Api_MonitoredResourceMetadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var systemLabels: SwiftProtobuf.Google_Protobuf_Struct {
    get {_systemLabels ?? SwiftProtobuf.Google_Protobuf_Struct()}
    set {_systemLabels = newValue}
  }
  /// Returns true if `systemLabels` has been explicitly set.
  public var hasSystemLabels: Bool {self._systemLabels != nil}
...
extension Google_Api_MonitoredResourceDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{3}display_name\0\u{1}description\0\u{1}labels\0\u{1}name\0\u{4}\u{2}launch_stage\0")
...
extension Google_Api_MonitoredResource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}labels\0")
...
extension Google_Api_MonitoredResourceMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}system_labels\0\u{3}user_labels\0")
