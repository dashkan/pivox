...
/// reason.
public enum Google_Api_ErrorReason: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  ///       }
  ///     }
  case apiKeyHTTPReferrerBlocked // = 7
  ...
  ///       }
  ///     }
  case apiKeyAndroidAppBlocked // = 9
  ...
  case locationTaxPolicyViolated // = 10
  ...
  ///       }
  ///     }
  case securityPolicyViolated // = 15
  ...
  ///       }
  ///     }
  case accessTokenScopeInsufficient // = 17
  ...
  ///       }
  ///     }
  case accessTokenTypeUnsupported // = 19
  ...
  ///       }
  ///     }
  case resourceProjectInvalid // = 21
  ...
  ///       }
  ///     }
  case resourceUsageRestrictionViolated // = 25
  ...
  ///       }
  ///     }
  case systemParameterUnsupported // = 26
  ...
  ///   }
  /// }
  case orgRestrictionViolation // = 27
  ...
  ///   }
  /// }
  case orgRestrictionHeaderInvalid // = 28
  ...
  case locationPolicyViolated // = 31
  ...
  public static let allCases: [Google_Api_ErrorReason] = [
    .unspecified,
    .serviceDisabled,
    .billingDisabled,
    .apiKeyInvalid,
...
extension Google_Api_ErrorReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ERROR_REASON_UNSPECIFIED\0\u{1}SERVICE_DISABLED\0\u{1}BILLING_DISABLED\0\u{1}API_KEY_INVALID\0\u{1}API_KEY_SERVICE_BLOCKED\0\u{1}RATE_LIMIT_EXCEEDED\0\u{1}RESOURCE_QUOTA_EXCEEDED\0\u{1}API_KEY_HTTP_REFERRER_BLOCKED\0\u{1}API_KEY_IP_ADDRESS_BLOCKED\0\u{1}API_KEY_ANDROID_APP_BLOCKED\0\u{1}LOCATION_TAX_POLICY_VIOLATED\0\u{1}USER_PROJECT_DENIED\0\u{1}CONSUMER_SUSPENDED\0\u{1}API_KEY_IOS_APP_BLOCKED\0\u{1}CONSUMER_INVALID\0\u{1}SECURITY_POLICY_VIOLATED\0\u{1}ACCESS_TOKEN_EXPIRED\0\u{1}ACCESS_TOKEN_SCOPE_INSUFFICIENT\0\u{1}ACCOUNT_STATE_INVALID\0\u{1}ACCESS_TOKEN_TYPE_UNSUPPORTED\0\u{1}CREDENTIALS_MISSING\0\u{1}RESOURCE_PROJECT_INVALID\0\u{2}\u{2}SESSION_COOKIE_INVALID\0\u{1}USER_BLOCKED_BY_ADMIN\0\u{1}RESOURCE_USAGE_RESTRICTION_VIOLATED\0\u{1}SYSTEM_PARAMETER_UNSUPPORTED\0\u{1}ORG_RESTRICTION_VIOLATION\0\u{1}ORG_RESTRICTION_HEADER_INVALID\0\u{1}SERVICE_NOT_VISIBLE\0\u{1}GCP_SUSPENDED\0\u{1}LOCATION_POLICY_VIOLATED\0\u{2}\u{2}MISSING_ORIGIN\0\u{1}OVERLOADED_CREDENTIALS\0")
}
