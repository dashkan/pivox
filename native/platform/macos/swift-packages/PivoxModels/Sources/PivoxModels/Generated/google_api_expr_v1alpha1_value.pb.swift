...
/// range of values.
public struct Google_Api_Expr_V1alpha1_Value: Sendable {
...
/// An enum value.
public struct Google_Api_Expr_V1alpha1_EnumValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Api_Expr_V1alpha1_ListValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Wrapped in a message so 'not set' and empty can be differentiated, which is
/// required for use in a 'oneof'.
public struct Google_Api_Expr_V1alpha1_MapValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct Entry: Sendable {
    ...
    public var key: Google_Api_Expr_V1alpha1_Value {
      get {_key ?? Google_Api_Expr_V1alpha1_Value()}
      set {_key = newValue}
    }
    ...
    public var value: Google_Api_Expr_V1alpha1_Value {
      get {_value ?? Google_Api_Expr_V1alpha1_Value()}
      set {_value = newValue}
    }
