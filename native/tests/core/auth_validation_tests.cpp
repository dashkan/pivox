...
// Auth validation logic — will move to core/ when we build the real auth
// module. For now, keep it here as test-driven specification of the validation
// rules.
...
TEST(AuthValidation, EmptyEmailIsInvalid) { EXPECT_FALSE(isValidEmail("")); }
