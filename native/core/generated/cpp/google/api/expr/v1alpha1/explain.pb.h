...
/* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.Explain.ExprStep) */ {
 public:
  ...
  void operator delete(Explain_ExprStep* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Explain_ExprStep* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.Explain) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Explain* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Explain* New(::google::protobuf::Arena* arena = nullptr) const {
