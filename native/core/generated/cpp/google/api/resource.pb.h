...
/* @@protoc_insertion_point(class_definition:google.api.ResourceReference) */ {
 public:
  ...
  void operator delete(ResourceReference* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ResourceDescriptor* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
...
inline std::string* ResourceDescriptor::add_pattern() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void ResourceDescriptor::set_pattern(int index, Arg_&& value, Args_... args) {
  ::google::protobuf::internal::AssignToString(
      *_internal_mutable_pattern()->Mutable(index),
...
inline void ResourceDescriptor::add_pattern(Arg_&& value, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::google::protobuf::internal::AddToRepeatedPtrField(*_internal_mutable_pattern(),
