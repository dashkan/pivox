...
inline void TimeOfDay::SharedDtor(MessageLite& self) {
  TimeOfDay& this_ = static_cast<TimeOfDay&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
  this_._impl_.~Impl_();
}

inline void* TimeOfDay::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
  return ::new (mem) TimeOfDay(arena);
}
constexpr auto TimeOfDay::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(TimeOfDay),
                                            alignof(TimeOfDay));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull TimeOfDay::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        &TimeOfDay::MergeImpl,
        ::google::protobuf::Message::GetNewImpl<TimeOfDay>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &TimeOfDay::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<TimeOfDay>(), &TimeOfDay::ByteSizeLong,
            &TimeOfDay::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* TimeOfDay::GetClassData() const {
...
// @@protoc_insertion_point(message_clear_start:google.type.TimeOfDay)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* TimeOfDay::_InternalSerialize(
          ...
          const TimeOfDay& this_ = static_cast<const TimeOfDay&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::uint8_t* TimeOfDay::_InternalSerialize(
            ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) const {
          const TimeOfDay& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::size_t TimeOfDay::ByteSizeLong(const MessageLite& base) {
          const TimeOfDay& this_ = static_cast<const TimeOfDay&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
