...
/* @@protoc_insertion_point(class_definition:google.api.VisibilityRule) */ {
 public:
  ...
  void operator delete(VisibilityRule* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  VisibilityRule* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:google.api.Visibility) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Visibility* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Visibility* New(::google::protobuf::Arena* arena = nullptr) const {
