...
#ifndef google_2ftype_2fpostal_5faddress_2eproto_2epb_2eh
#define google_2ftype_2fpostal_5faddress_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:google.type.PostalAddress) */ {
 ...
 public:
  ...
  void set_address_lines(int index, Arg_&& value, Args_... args);
  std::string* add_address_lines();
  template <typename Arg_ = const std::string&, typename... Args_>
  void add_address_lines(Arg_&& value, Args_... args);
...
inline void PostalAddress::set_allocated_sorting_code(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.sorting_code_.IsDefault()) {
...
inline void PostalAddress::set_allocated_administrative_area(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.administrative_area_.IsDefault()) {
...
inline void PostalAddress::set_allocated_sublocality(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.sublocality_.IsDefault()) {
...
inline std::string* PostalAddress::add_address_lines() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
template <typename Arg_, typename... Args_>
inline void PostalAddress::set_address_lines(int index, Arg_&& value, Args_... args) {
  ::google::protobuf::internal::AssignToString(
      *_internal_mutable_address_lines()->Mutable(index),
      std::forward<Arg_>(value), args... );
  // @@protoc_insertion_point(field_set:google.type.PostalAddress.address_lines)
}
template <typename Arg_, typename... Args_>
inline void PostalAddress::add_address_lines(Arg_&& value, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::google::protobuf::internal::AddToRepeatedPtrField(*_internal_mutable_address_lines(),
...
inline std::string* PostalAddress::add_recipients() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
template <typename Arg_, typename... Args_>
inline void PostalAddress::set_recipients(int index, Arg_&& value, Args_... args) {
  ::google::protobuf::internal::AssignToString(
...
template <typename Arg_, typename... Args_>
inline void PostalAddress::add_recipients(Arg_&& value, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
#endif  // google_2ftype_2fpostal_5faddress_2eproto_2epb_2eh
