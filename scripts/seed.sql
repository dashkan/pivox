...
-- Generated by cmd/gen-permissions; runs last (needs all roles seeded).
\i scripts/seeds/16_role_permissions.sql
-- Sample workflow for local-corp (needs local-corp from 11_local_corp.sql).
\i scripts/seeds/17_sample_workflow.sql
-- Sample connectors for local-corp (needs local-corp + its spaces from
-- 11_local_corp.sql).
\i scripts/seeds/18_sample_connectors.sql
